...
pub use crate::core::{
    ...
    CoreRegisters, CoreState, CoreStatus, HaltReason, MemoryMappedRegister, RegisterDataType,
    RegisterId, RegisterRole, RegisterValue, SpecificCoreState, VectorCatchCondition,
};
